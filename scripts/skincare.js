...
let data=[{
   ...
   "Description":"Tea Tree Oil & Vitamin E-infused Face Wash",
     "Use":"Kills germs Removes impurities, nourishes, moisturizes and keeps face germ-free Enriched with tea tree oil a natural antiviral and antibacterial agent Enhanced with vitamin E beads that nourishes the skin Enriched with cucumber extract that moisturizes the skin and keeps it soft Enriched with aloe vera extract that soothes and calms the skin Infused with turmeric extract, an anti-inflammatory that reduces irritation and pigmentation Infused with sandalwood extract, an antiseptic that purifies the skin Infused with tulsi oil, an antifungal that treats infection and other skin ailments Contains chlorhexidine known for its disinfectant powers Non-comedogenic",
    "benifit":"Kills germs Light gel texture Removes impurities, nourishes, moisturizes and keeps face germ-free Non-comedogenic Gentle on your skin, tough on dirt, pollution and germs",
    ...
    "Description":"Mandarin-infused Brightening Sheet Mask",
     "Use":"Apply this face mask after cleansing and toning your skin.  Align the mask using the eye and nose cut-outs as a guide and spread it out across your face.  Leave the mask on for 20-30 minutes and relax   Remove the mask and gently pat any excess serum onto the face and neck. Let your skin soak it all in.",
    "benifit":"Enriched with mandarin and white truffle Brightening and moisturisin  Strengthens and rejuvenates the skin Mild formula Gives your skin a youthful glow",
    ...
    "Description":"Rose & Honey Infused Germ-killing & Purifying Face scrub",
     "Use":"Kills germs  Exfoliates dead skin cells  Antioxidant honey extracts Soothing rose extracts Leaves skin feeling fresh and soft",
    "benifit":"Benefits  Exfoliates skin  Removes dead skin and impurities for smooth skin. Soothing & Antioxidant  Along with  anti-bacterial and anti-fungal properties,  gives your skin a relaxing and calming effect.  Kills germs  The rose & honey face scrub formulated with chlorhexidine safeguards against germs and protects skin from dirt and pollution.",
    ...
    "Use":"Gel based face pack   Made from pure, concentrated aloe vera juice and enriched with ayurvedic ingredients like kesar  Blended with kesar and ginger  Lightweight formula   Deeply nourishes dull, dehydrated skin  Helps lighten darks spots and pigmentation  Acts as a powerful antioxidant and detoxes the skin  Helps heal and regenerate the ski  Brightens the skin Improves elasticity and tones the skin Improves blood circulation for healthier, radiant skin  Formulated for all skin types",
    "benifit":"Deeply nourishing Intensely hydrating  Helps lighten darks spots and pigmentation  Helps heal and regenerate the skin Brightens the skin Improves elasticity and tones the skin  Detoxes the skin  Soaks the skin in antioxidants  Improves circulation for healthier, radiant skin",
    ...
    "Use":"Highly concentrated formula with 10% Niacinamide  Enriched with nourishing moringa & tiger grass  Unique light-weight, serum-gel texture  Balances out & evens skin tone  Has anti-inflammatory benefits   Helps regulate sebum production  Reduces blemishes and tackles redness",
     "benifit":"Benefits Treats Acne and Blemishes  Niacinamide concentration helps reduce dark spots, treat hyperpigmentation and reduce pore lining; resulting in reduced acne. This makes it the perfect choice for oily skin. Provide Moisture Boost The addition of hyaluronic acid in this formula allows the skin to retain moisture, resulting in smooth, hydrated skin. Reduces Inflammation  Formulated to help reduce redness and inflammation of the skin, and the natural antioxidants added to this formula calm and soothe the skin. The MyGlamm Serum Range is rooted in science-based innovation combined with natural actives formulated especially for Indian skin, to deliver lasting results and a more balanced, even and healthy skin tone.",
    ...
    "Description":"Marine 3-in-1 Exfoliating, Cleansing & Hydrating Face Mask",
     "Use":"Unique jelly-like texture  High-moisture exfoliating mask Foams well to effectively remove dirt & impurities Glides softly & thickly on skin  Deeply hydrates & leaves skin soft & clean",
    
     "benifit":"Long-lasting hydration: This cleansing mask is formulated with a unique gelling system that absorbs and retains moisture long after use. Massages and exfoliates: Get that spa experience without stepping out. The soft, jelly-like texture of this mask exfoliates while providing you with a gentle massage as you apply it. Introducing MyGlamm YOUTHfull - a comprehensive, first-of-its-kind, marine-inspired skincare range made in South Korea. It uses Water Bank Technology that enables faster penetration of moisture into the skin. It also contains Marine Complex 5, a blend of marine actives rich in nutrients that have anti-inflammatory and anti-ageing benefits. A complete range of skincare essentials that will transform your skin, keeping it fresh, hydrated and glowing",
    ...
    "benifit":"Brightens the skin: This strawberry face cream brightens the skin & lightens the appearance of scars.   Fights free radicals: Contains antioxidant-rich strawberries & blueberries that help fight free radicals to give you healthier skin  Moisturizes & protects: Contains shea-butter that hydrates & nourishes the skin.  Prevents premature ageing: The antioxidant content promotes collagen production, which in turn improves the skin’s elasticity  Lightweight texture: This face cream is super-light & gets quickly absorbed into the skin. SUPERFOODS Blueberry & Kakadu Plum Sleeping Mask  Repairs & revitalizes skin: This natural sleeping mask revives skin’s radiance with a Vit B3 (Niacinamide) gel network that gets activated when applied to the skin.  Nourishes and hydrates skin: Kakadu plum extracts provide intense nutrition to the skin and add to its natural moisture level  Rich in antioxidants: Blueberry extracts combat daily free radical damage. Enhanced Properties: ",
